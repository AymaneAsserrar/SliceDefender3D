...
namespace {
struct qt_meta_tag_ZN13WebcamHandlerE_t {};
} // unnamed namespace

template <> constexpr inline auto WebcamHandler::qt_create_metaobjectdata<qt_meta_tag_ZN13WebcamHandlerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<WebcamHandler, qt_meta_tag_ZN13WebcamHandlerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject WebcamHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13WebcamHandlerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13WebcamHandlerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13WebcamHandlerE_t>.metaTypes,
    nullptr
} };
...
void WebcamHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WebcamHandler::*)(const QImage & )>(_a, &WebcamHandler::frameReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (WebcamHandler::*)(const QPoint & )>(_a, &WebcamHandler::handDetected, 1))
            return;
    }
}
...
void *WebcamHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13WebcamHandlerE_t>.strings))
